...
import com.ai.template.config.CosConfig;
...
public class CosService {
    ...
    public String uploadImageData(ImageData imageData, String folder) {
        ...
        try {
            ...
            log.error("上传 ImageData �?COS 失败, dataType={}", imageData.getDataType(), e);
            return null;
        }
    }
    ...
    public String uploadFromUrl(String imageUrl, String folder) {
        ...
        try {
            ...
            log.error("�?URL 上传图片�?COS 失败: {}", imageUrl, e);
            return null;
        }
    }
    ...
    public String uploadFile(File file, String folder) {
        try {
            ...
            log.error("上传文件�?COS 失败: {}", file.getName(), e);
            return null;
        }
    }
