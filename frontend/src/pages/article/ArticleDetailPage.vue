<template>
  <div class="article-detail-page">
    ...
    <div class="container">
      <a-spin :spinning="loading" tip="加载�?..">
        <a-card :bordered="false" v-if="article" class="article-card">
          ...
          <div class="title-section">
            ...
            <div class="meta-info">
              ...
              <span class="time">创建�?{{ article.createTime ? formatDate(article.createTime) : '' }}</span>
            </div>
          </div>
...
const exportMarkdown = () => {
  ...
  const nameMap: Record<string, string> = {
    ...
    'agent4_analyze_image_requirements': '分析配图需�?,
