    ...
    <div class="page-header">
      <div class="header-container">
        <div class="header-content">
          ...
          <p class="page-subtitle">管理您创作的所有文�?/p>
        </div>
      ...
      <div class="filter-bar">
        <div class="filter-left">
          ...
          <a-select
            ...
            class="status-select"
          >
            <a-select-option value="">全部状�?/a-select-option>
            <a-select-option value="COMPLETED">已完�?/a-select-option>
            <a-select-option value="PROCESSING">生成�?/a-select-option>
        ...
        <div class="filter-right">
          <span class="total-count">�?{{ pagination.total }} 篇文�?/span>
        </div>
      </div>
