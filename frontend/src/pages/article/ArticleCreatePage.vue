            ...
            <div class="input-area">
              ...
              <div class="image-methods-section">
                ...
                <a-checkbox-group v-model:value="selectedImageMethods" class="methods-group">
                  ...
                  <a-checkbox value="EMOJI_PACK">表情�?/a-checkbox>
                  <a-tooltip :title="isVip ? '' : '仅限 VIP 会员'">
                ...
                <div v-if="!isVip" class="vip-notice">
                  <CrownOutlined />
                  <span>AI 生图�?SVG 图表�?VIP 专属功能�?/span>
      ...
      <aside class="sidebar-right">
        ...
        <div v-if="currentPhase === 'INPUT'" class="panel-section quota-section">
          ...
          <div v-if="isAdmin" class="quota-admin">
            <span class="quota-badge admin">管理�?/span>
            <span class="quota-text">无限�?/span>
          </div>
          ...
          <div class="tips-list">
            <div class="tip-item">
              ...
              <div class="tip-content">
                ...
                <div class="tip-desc">直击用户最关心的问�?/div>
              </div>
            </div>
            <div class="tip-item">
              <div class="tip-icon">2</div>
              <div class="tip-content">
                <div class="tip-title">制造悬�?/div>
            ...
            <div class="tip-item">
              ...
              <div class="tip-content">
                ...
                <div class="tip-desc">使用具体数据增加说服�?/div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="currentPhase === 'TITLE_SELECTING'" class="panel-section tips-section">
          ...
          <div class="tips-list">
            <div class="tip-item">
              <div class="tip-icon">�?/div>
              <div class="tip-content">
                <div class="tip-desc">选择最符合您期望的标题，或添加补充描述�?AI 更好地理解您的需�?/div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="tips-list">
            <div class="tip-item">
              ...
              <div class="tip-content">
                ...
                <div class="tip-desc">点击章节左侧拖动图标可调整章节顺�?/div>
              </div>
            </div>
            <div class="tip-item">
              <div class="tip-icon">2</div>
              <div class="tip-content">
                ...
                <div class="tip-desc">使用 AI 助手快速修改大纲结�?/div>
              </div>
            </div>
            <div class="tip-item">
              <div class="tip-icon">3</div>
              <div class="tip-content">
                ...
                <div class="tip-desc">根据需要添加或删除章节和要�?/div>
              </div>
            </div>
          </div>
        </div>
...
const agentSteps = [
  { title: '生成标题', description: 'AI 分析选题，生成吸睛标�? },
  { title: '规划大纲', description: '构建文章结构，理清脉�? },
  { title: '撰写正文', description: '流式生成高质量文章内�? },
  { title: '分析配图', description: '智能分析配图需求和位置' },
  { title: '生成配图', description: '自动匹配高清无版权图�? },
...
const selectedStyle = ref('')  // 选中的文章风格（空字符串表示默认�?const selectedImageMethods = ref<string[]>([])  // 选中的配图方式（空数组表示全部）
...
const handleSSEMessage = (msg: SSEMessage) => {
  ...
  switch (msg.type) {
    ...
    case 'TITLES_GENERATED':
      ...
      isCreating.value = false
      addLog(`生成�?${msg.titleOptions?.length || 0} 个标题方案`, 'success')
      break
    ...
    case 'AGENT4_COMPLETE':
      ...
      addLog(`配图需求分析完成，�?${totalImages.value} 张`, 'success')
      break
    ...
    case 'IMAGE_COMPLETE':
      ...
      addLog(`配图生成�?${imageCount.value}/${totalImages.value}`, 'info')
      break
