...
const features = [
  ...
  },
  {
    ...
    title: '快速高�?,
    description: '5-10分钟完成全文创作，效率提�?0�?,
    color: '#EF4444'
  },
  {
    ...
    <div class="hero-section">
      ...
      <div class="container">
        <div class="hero-badge">
          <ThunderboltOutlined />
          <span>AI 驱动的内容创作平�?/span>
        </div>
        <h1 class="hero-title">AI 爆款文章创作�?/h1>
        <p class="hero-subtitle">让每个人都能写出 10�? 文章</p>
        ...
        <p class="hero-tips">工作总结、心得体会、演讲稿、分析报�?.. 一键生�?/p>
      </div>
    </div>
    ...
    <div class="features-section">
      <div class="container">
        <div class="section-header">
          ...
          <p class="section-subtitle">强大�?AI 能力，让创作变得简单高�?/p>
        </div>
    ...
    <div v-if="loginUserStore.loginUser.id && recentArticles.length > 0" class="articles-section">
      <div class="container">
        <div class="section-header-row">
          <div>
            <h2 class="section-title-sm">最近创�?/h2>
              ...
              <div class="article-info">
                ...
                <div class="article-meta">
                  ...
                  <span :class="['article-status', `status-${article.status?.toLowerCase()}`]">
                    {{ article.status === 'COMPLETED' ? '已完�? : article.status === 'PROCESSING' ? '生成�? : '等待�? }}
                  </span>
                </div>
              </div>
            </div>
