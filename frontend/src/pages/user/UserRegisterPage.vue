    ...
    <div class="auth-container">
      ...
      <div class="brand-section">
        ...
        <div class="brand-content">
          ...
          <h1 class="brand-title">AI 爆款文章创作�?/h1>
          <p class="brand-subtitle">让每个人都能写出 10�? 文章</p>
      ...
      <div class="form-section">
        <div class="form-card">
          ...
          <p class="form-subtitle">注册开启您�?AI 创作之旅</p>
          
          <a-form :model="formState" name="basic" autocomplete="off" @finish="handleSubmit" class="register-form">
            <a-form-item name="userAccount" :rules="[{ required: true, message: '请输入账�? }]">
              <a-input 
